...
int32_t main()
{
    ...
    while (q--)
    {
        string t;
        cin >> t;
        if (t.compare("pop_back") == 0)
        {
            s.pop_back();
        }
        else if (t.compare("back") == 0)
        {
            cout << s.back() << nn;
        }
        else if (t.compare("front") == 0)
        {
            cout << s.front() << nn;
        }
        ...
        else if (t.compare("substr") == 0)
        {
            ll l, r;
            cin >> l >> r;
            if (l > r)
                swap(l, r);
            cout << s.substr(l - 1, r - l + 1) << nn;
        }
        else if (t.compare("sort") == 0)
        {
            ll l, r;
            cin >> l >> r;
            if (l > r)
